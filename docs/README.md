...
| File | Purpose | Doc |
|---|---|---|
| `__init__.py` (repo root) | Hermes plugin entrypoint — registers the ClawChat platform, tool module, CLI, slash command, and hooks | [plugin-entrypoint.md](./plugin-entrypoint.md) |
